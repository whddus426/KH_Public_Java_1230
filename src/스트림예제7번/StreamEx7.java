...
// 스트림의 최종 연산 : 중개 연산을 통해 변환딘 스트림은 마지막으로 최종 연산을 통해 요소를 소모하여 결과를 표시
// 최종 연산 시 모든 요소를 소모한 해당 스트림은 더 이상 할 수 없습니다.
// 요소의 출력 : forEach()
...
public class StreamEx7 {
    public static void main(String[] args) {
        ...
        OptionalInt rst1 = stream3.sorted().findFirst(); // 정력 이후 첫번째 값을 가져 옴
        ...
        // 요소의 검사 :
        // - anyMatch() : 해당 스트림의 일부 요소가 특징 조건을 만족할 경우 true
