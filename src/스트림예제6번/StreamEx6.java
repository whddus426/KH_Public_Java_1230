...
// 스트림 중개 연산 : 생성된 스트림은 중개 연산을 동해 또 다른 스트림으로 변환 됩니다.
// 중개 연산은 연속으로 연결해서 여러개 사용 사능 합니다.
// filter() : 해당 스트림에서 주어진 조건에 맞는 요소로만 구성된 새로운 스트림 변환
...
public class StreamEx6 {
    public static void main(String[] args) {
        ...
        // flatMap() : map()은 입력한 원소를 그대로 스트림으로 반환 하지만, flatMap()은 입력한 원소를 가장 작은 단일 스트림으로 반환
